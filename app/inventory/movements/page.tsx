    ...
    <div className="flex flex-1 flex-col gap-6 p-4 md:p-6 max-w-4xl">
      ...
      <Tabs defaultValue={filter} className="w-full">
        <TabsList className="mb-6">
          ...
          <TabsTrigger value="IN" asChild><a href="?filter=IN">Stock In</a></TabsTrigger>
          <TabsTrigger value="OUT" asChild><a href="?filter=OUT">Stock Out</a></TabsTrigger>
          <TabsTrigger value="ADJUSTMENTS" asChild><a href="?filter=ADJUSTMENTS">Adjustments</a></TabsTrigger>
        </TabsList>
